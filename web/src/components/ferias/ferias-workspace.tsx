...
const buttonClass = "inline-flex min-h-11 items-center justify-center gap-2 app-radius-lg px-4 py-2 text-sm font-semibold transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--app-teal)] disabled:cursor-not-allowed disabled:opacity-40";
    ...
    <div className="mx-auto min-w-0 max-w-6xl space-y-6 text-[color:var(--app-fg)]">
      ...
      <section aria-labelledby="ferias-file-title" className="space-y-4">
        ...
        <input id="ferias-file" type="file" accept=".xlsx,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
          aria-describedby="ferias-file-limit" className="block min-h-11 w-full min-w-0 app-radius-lg border border-[color:var(--app-border)] bg-[color:var(--app-input)] p-2 text-sm file:mr-3 file:rounded-md file:border-0 file:bg-[color:var(--app-teal)] file:px-3 file:py-2 file:font-semibold file:text-[color:var(--app-canvas)] focus-visible:outline-2 focus-visible:outline-[color:var(--app-teal)]"
        ...
        {model.file && (
          <div className="flex min-w-0 items-center justify-between gap-3 app-radius-lg border border-[color:var(--app-border)] bg-[color:var(--app-surface)] p-3">
