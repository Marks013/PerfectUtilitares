...
export function drawHeader(doc: PDFKit.PDFDocument) {
...
export function drawSummary(doc: PDFKit.PDFDocument, report: JornadaBatchReport, y: number) {
  const margin = doc.page.margins.left;
  const width = doc.page.width - margin * 2;
  const cardGap = 8;
...
export function drawErrors(doc: PDFKit.PDFDocument, report: JornadaBatchReport, y: number) {
...
export function drawFrequentSchedules(
  doc: PDFKit.PDFDocument,
...
export function drawDetailedSchedules(
  doc: PDFKit.PDFDocument,
  report: JornadaBatchReport,
  y: number,
) {
...
export function drawNoErrors(doc: PDFKit.PDFDocument, y: number) {
  const margin = doc.page.margins.left;
  const width = doc.page.width - margin * 2;
