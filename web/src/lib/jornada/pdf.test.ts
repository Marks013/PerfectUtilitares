...
import { generateJornadaHistoryPdf, getJornadaPdfDebugGroups } from "./pdf";
...
describe("generateJornadaHistoryPdf", () => {
  ...
  it("keeps the same schedule separated when change dates are different", () => {
    const records = [
      {
        id: "cm123",
        createdAt: new Date("2026-05-07T12:00:00Z"),
